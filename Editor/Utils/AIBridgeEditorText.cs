    ...
    internal static class AIBridgeEditorText
    {
        ...
        private static string GetTemplate(AIBridgeEditorTextKey key)
        {
            switch (key)
            {
                ...
                case AIBridgeEditorTextKey.QuickSkillHelp: return T("Generate the aibridge skill and copy both skills to selected agent directories", "生成 aibridge Skill，并将两个 Skill 复制到选定的 Agent 目录");
                ...
                case AIBridgeEditorTextKey.SkillDocHelp: return T("Regenerate the aibridge skill command list", "重新生成 aibridge Skill 命令清单");
